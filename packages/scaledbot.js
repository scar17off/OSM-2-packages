...
`;
            ...
            OWOP.tool.addToolObject(new OWOP.tool.class("Bot Protection 16", OWOP.cursors.shield, OWOP.fx.player.RECT_SELECT_ALIGNED(16), OWOP.RANK.USER, tool => {
            ...
            OWOP.tool.addToolObject(new OWOP.tool.class("Bot Protection 32", OWOP.cursors.shield, OWOP.fx.player.RECT_SELECT_ALIGNED(32), OWOP.RANK.USER, tool => {
                tool.setFxRenderer((fx, ctx) => {
                    const X = fx.extra.player.x,
                        Y = fx.extra.player.y,
            ...
            OWOP.tool.addToolObject(new OWOP.tool.class("Bot Protection 64", OWOP.cursors.shield, OWOP.fx.player.RECT_SELECT_ALIGNED(64), OWOP.RANK.USER, tool => {
                tool.setFxRenderer((fx, ctx) => {
                    const X = fx.extra.player.x,
                        Y = fx.extra.player.y,
